/*-----------------------------------------
   WHATSIZE.C -- Quelle est la taille de la fenêtre ?
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Quelle est la taille de la fenêtre ?"),
                          WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     static TCHAR szHeading [] =
          TEXT ("Mode topogr.            Gauche   Droite     Haut  Bas") ;
