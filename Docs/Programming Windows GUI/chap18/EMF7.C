                    ...
                    PSTR lpszCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Démo EMF N° 7"),
                          WS_OVERLAPPEDWINDOW,
