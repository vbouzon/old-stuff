...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_LBUTTONDOWN :
          ...
          // Au message SetFocus, définir le focus sur la fenêtre enfant 
     case WM_SETFOCUS:
          SetFocus (GetDlgItem (hwnd, idFocus)) ;
          return 0 ;

          // Au message Keydown, possibilité de changer le focus de fenêtre
                               ...
                               WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_KEYDOWN:
               // Envoyer la touche pressée à la fenêtre parent
     ...
     case WM_LBUTTONDOWN :
          ...
          return 0 ;
               ...
               // Pour le message focus, invalider la fenêtre pour la repeindre 
