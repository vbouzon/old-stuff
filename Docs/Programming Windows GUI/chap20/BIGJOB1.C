/*----------------------------------------
   BIGJOB1.C -- Démonstration de multithreading
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Démonstration de multithreading"),
                          WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     static TCHAR * szMessage[] = { TEXT ("Prêt (le bouton gauche commence)"),
                                    TEXT ("En cours (le bouton droit termine)"),
                                    TEXT ("%d répétitions en %ld msec") } ;
     HDC            hdc ;
     PAINTSTRUCT    ps ;
     RECT           rect ;
     TCHAR          szBuffer[64] ;
