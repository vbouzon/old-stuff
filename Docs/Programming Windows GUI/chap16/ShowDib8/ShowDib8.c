/*--------------------------------------------------
   SHOWDIB8.C - Affiche une DIB convertie en section DIB
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Show DIB n°8 : DIB convertie en section DIB"),
                          WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_COMMAND:
          ...
          case IDM_FILE_OPEN:
               ...
               if (pPackedDib)
               {
                         // Crée la section DIB  à partir de la DIB
                    ...
                    CopyMemory (pBits, PackedDibGetBitsPtr  (pPackedDib),
                         ...
                         // Crée la palette à partir de la DIB
