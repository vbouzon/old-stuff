/*----------------------------------------
   SYSPAL1.C - Affiche la palette système
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Palette système n°1"), 
                          WS_OVERLAPPEDWINDOW, 
...
BOOL CheckDisplay (HWND hwnd)
{
     ...
     if (iPalSize != 256)
     {
          MessageBox (hwnd, TEXT ("Dans ce programme, le mode d'affichage")
                            TEXT ("doit posséder une palette 256 couleurs."),
                      szAppName, MB_ICONERROR) ;
          return FALSE ;
     }
     return TRUE ;
