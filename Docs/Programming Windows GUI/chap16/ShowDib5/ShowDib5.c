...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_CREATE:
          ...
          ofn.lpTemplateName    = NULL ;
               ...
               // Création de la palette universelle
     ...
     case WM_COMMAND:
          ...
          case IDM_FILE_OPEN:
               ...
               if (!GetOpenFileName (&ofn))
                    ...
                    // Libérer la mémoire si une DIB compressée a été chargée
     ...
     case WM_PAINT:
          ...
          if (pPackedDib)
          {
                   // Définit le mode de déformation en demi-teintes

               SetStretchBltMode (hdc, HALFTONE) ;
               SetBrushOrgEx (hdc, 0, 0, NULL) ;

                    // Sélectionne et réalise la palette en demi-teintes

               SelectPalette (hdc, hPalette, FALSE) ;
               RealizePalette (hdc) ;

                    // StretchDIBits de préférence à SetDIBitsToDevice
