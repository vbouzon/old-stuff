/*------------------------------------------
   SHOWDIB7.C - Affiche les DIB converties en DDB 
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Show DIB n°7 : convertit une DIB en DDB"),
                          WS_OVERLAPPEDWINDOW,
     ...
     case WM_COMMAND:
          ...
          case IDM_FILE_OPEN:
               ...
               if (!GetOpenFileName (&ofn))
                    ...
                    // Libère la mémoire si une DIB a été chargée
               ...
               if (hBitmap)
               {
                    ...
                    // Supprime une éventuelle palette logique
               ...
               if (pPackedDib)
               {
                         // Crée la palette à partir de la DIB et la 
                         // sélectionne dans le contexte de périphérique
                    ...
                    ReleaseDC (hwnd, hdc) ;
                         ...
                         // Libère la mémoire de la DIB compressée
