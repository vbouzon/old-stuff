/*-----------------------------------------------
   GRAYS3.C - Niveaux de gris utilisant le gestionnaire de palette
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Niveaux de gris n°3"),
                          WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     {
     case WM_CREATE:
               // Alloue la mémoire nécessaire à une structure LOGPALETTE
               // et crée une palette
     ...
     case WM_PAINT:
          hdc = BeginPaint (hwnd, &ps) ;
               ...
               // Sélectionne et réalise la palette 
               // dans le contexte de périphérique

          SelectPalette (hdc, hPalette, FALSE) ;
          RealizePalette (hdc) ;

               // Dessine le dégradé de gris
