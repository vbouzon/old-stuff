/*---------------------------------------
   BOUNCE.C -- Démo d'animation de palette
...
TCHAR szTitle   [] = TEXT ("Bounce: Démo d'animation de palette") ;
...
void PaintRoutine (HDC hdc, int cxClient, int cyClient)
{
     ...
     RECT   rect ;
          ...
          // Trace l'arrière-plan de la fenêtre
          // à l'aide de l'index 33 de la palette
