/*------------------------------------------------
   SHOWDIB6.C - Affiche une DIB avec des index de la palette
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Show DIB n°6 : Index de palette"),
                          WS_OVERLAPPEDWINDOW,
     ...
     case WM_COMMAND:
          ...
          case IDM_FILE_OPEN:
               ...
               if (!GetOpenFileName (&ofn))
                    ...
                    // Libère la mémoire si une DIB compressée a été chargée
               ...
               if (pPackedDib)
               {
                    ...
                    // Supprime la palette logique éventuelle
               ...
               if (pPackedDib)
               {
                         // Crée la palette à partir de la table
                         // des couleurs de la DIB

                    hPalette = PackedDibCreatePalette (pPackedDib) ;

                         // Remplace la table des couleurs de la DIB par des index
