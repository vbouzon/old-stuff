/*-----------------------------------------------
   GRAYS2.C -- Niveaux de gris à l'aide du Gestionnaire de palette
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Niveaux de gris n°2"),
                          WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     {
     case WM_CREATE:
               // Alloue mémoire pour la structure LOGPALETTE
               // et crée une palette
