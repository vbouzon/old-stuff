/*-----------------------------------------------------
   POPPAD2.C --  Éditeur Popup Version 2 (avec menu)
...
{
     return MessageBox (hwnd, TEXT ("Souhaitez-vous vraiment quitter PopPad2?"),
     ...
     case WM_COMMAND:
          if (lParam)
          {
               if (LOWORD (lParam) == ID_EDIT &&
                    ...
                    MessageBox (hwnd, TEXT ("Le contrôle d'édition manque d'espace libre."),
