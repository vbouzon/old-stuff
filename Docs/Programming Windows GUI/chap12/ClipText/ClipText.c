/*-----------------------------------------
   CLIPTEXT.C - Presse-papiers et texte
...
TCHAR szDefaultText[] = TEXT ("Texte par défaut - Version Unicode") ;
TCHAR szCaption[]     = TEXT ("Transferts de texte vers le press-papiers - Version Unicode") ;

#else

#define CF_TCHAR CF_TEXT
TCHAR szDefaultText[] = TEXT ("Texte par défaut - Version ANSI") ;
TCHAR szCaption[]     = TEXT ("Transferts de texte vers le presse-papiers - Version ANSI") ;
