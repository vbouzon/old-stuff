/*--------------------------------------------------------
   DIBSECT.C - Affiche une section DIB dans la zone client
                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     hwnd = CreateWindow (szAppName, TEXT ("Affichage de section DIB"),
                          WS_OVERLAPPEDWINDOW,
...
HBITMAP CreateDibSectionFromDibFile (PTSTR szFileName)
{
     ...
     HBITMAP          hBitmap ;
          ...
          // Ouverture du fichier :  accès en lecture, interdit l'accès en écriture
                   ...
                   || (bmfh.bfType != * (WORD *) "BM"))
     {
          ...
          // Allocation de mémoire pour la structure BITMAPINFO
           // et lecture
     ...
     if (hBitmap == NULL)
     {
          ...
          // Lit les bits de l'image bitmap
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_COMMAND:
          ...
          case IDM_FILE_OPEN:
                    ...
                    // Affiche la boîte de dialogue Ouverture de fichier

               if (!GetOpenFileName (&ofn))
                    return 0 ;
               
                    // Si une autre bitmap existe, la supprimer
               ...
               if (hBitmap)
               {
                    ...
                    // Crée la section DIB  à partir du fichier DIB
