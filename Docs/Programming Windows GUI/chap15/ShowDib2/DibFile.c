/*---------------------------------
   DIBFILE.C - Fonctions des fichiers DIB
  ---------------------------------*/
...
void DibFileInitialize (HWND hwnd)
{
     ...
     ofn.nFilterIndex      = 0 ;
     ofn.lpstrFile         = NULL ;          // Défini dans fonctions Open et Close
     ofn.nMaxFile          = MAX_PATH ;
     ofn.lpstrFileTitle    = NULL ;          // Défini dans fonctions Open et Close
     ofn.nMaxFileTitle     = MAX_PATH ;
     ofn.lpstrInitialDir   = NULL ;
     ofn.lpstrTitle        = NULL ;
     ofn.Flags             = 0 ;             // Défini dans fonctions Open et Close
     ofn.nFileOffset       = 0 ;
